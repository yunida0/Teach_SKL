...
$routes = [
    ...
    'data/dokumentasi-embed' => 'data/get_dokumentasi_embed.php',
    ...
    'actions/absensi-mandiri-murid' => 'actions/absensi_mandiri_murid.php',
    'absensi_mandiri_murid' => 'actions/absensi_mandiri_murid.php',
    ...
    'actions/reset-quiz-result' => 'actions/reset_quiz_result.php',
    ...
    'actions/update-tugas' => 'actions/update_tugas.php',
    'update_tugas' => 'actions/update_tugas.php',
    ...
    'actions/save-dokumentasi-embed' => 'actions/save_dokumentasi_embed.php',
